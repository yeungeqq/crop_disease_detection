...
Run Block 7 to perform stratified k-fold cross-validation, train the SVM classifier on the extracted features, and evaluate its performance.

4. Train and evaluate the Random Forest model
Run Block 8 to train the RF classifier using the extracted features and evaluate its performance using stratified k-fold cross-validation.